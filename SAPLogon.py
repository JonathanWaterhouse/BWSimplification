...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(385, 276)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8("SAP.jpg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Dialog.setWindowIcon(icon)
        self.user_lineEdit = QtGui.QLineEdit(Dialog)
        self.user_lineEdit.setGeometry(QtCore.QRect(100, 10, 261, 20))
        ...
        self.password_lineEdit.setGeometry(QtCore.QRect(100, 40, 261, 20))
        ...
        self.msg_server_lineEdit.setGeometry(QtCore.QRect(100, 190, 261, 20))
        ...
        self.group_lineEdit.setGeometry(QtCore.QRect(100, 160, 261, 20))
        ...
        self.cancel_pushButton.setGeometry(QtCore.QRect(310, 230, 51, 23))
        self.cancel_pushButton.setObjectName(_fromUtf8("cancel_pushButton"))
        self.OK_pushButton = QtGui.QPushButton(Dialog)
        self.OK_pushButton.setGeometry(QtCore.QRect(250, 230, 51, 23))
        ...
        self.client_lineEdit.setGeometry(QtCore.QRect(100, 100, 113, 20))
        ...
        Dialog.setTabOrder(self.system_lineEdit, self.langu_lineEdit)
